...
begin
  ...
  writeln('--- Range Expansion Tests ---');
  
  { Test character ranges }
  letters := ['A'..'Z'];
  writeln('Uppercase letters [A..Z] contains 26 elements');
  ...
  writeln('Actually contains: ', i, ' elements');
  
  { Test digit ranges }
  digits1 := [0..9];
  writeln('Digits [0..9] should contain all 10 digits');
  
  i := 0;
  for digit := 0 to 9 do
  begin
    if digit in digits1 then
      i := i + 1;
  end;
  writeln('Actually contains: ', i, ' elements');
  ...
  writeln('Days [Monday..Sunday] should contain all 7 days');
  
  i := 0;
  for day := Monday to Sunday do
  begin
    if day in alldays then
      i := i + 1;
  end;
  writeln('Actually contains: ', i, ' elements');
  writeln();
